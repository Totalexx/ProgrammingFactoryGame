...
namespace RoslynCSharp
{
    public class Compiler : IDisposable
    {
        ...
        private void InitCompiler(string appDomainName)
        {
            ...
            _compilationOptions = new CSharpCompilationOptions(outputKind: OutputKind.DynamicallyLinkedLibrary)
                .WithOptimizationLevel(_roslynSettings.optimizationLevel)
                .WithAllowUnsafe(_roslynSettings.allowUnsafeCode)
                .WithConcurrentBuild(_roslynSettings.allowConcurrentCompile);
